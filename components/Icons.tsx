...
export const ProcurementIcon = ({ className }: { className?: string }) => (
...
// NEW: Truck icon specifically for suppliers/procurement if needed, but ProcurementIcon above is good.
